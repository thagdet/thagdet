...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Detcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"detcointools.com", "118.69.187.7"},
    {"detcoinpool.org", "dnsseed.detcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"detcointools.com", "testnet-seed.detcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Detcoin is probably already running."), addrBind.ToString().c_str());
        else
